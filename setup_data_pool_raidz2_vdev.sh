...
zpool add -o ashift=${ashift} ${poolname} raidz2 "/dev/mapper/${luksdevices[6]}" "/dev/mapper/${luksdevices[7]}" "/dev/mapper/${luksdevices[8]}" "/dev/mapper/${luksdevices[9]}" "/dev/mapper/${luksdevices[10]}" "/dev/mapper/${luksdevices[11]}"
